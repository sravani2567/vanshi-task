...
import './App.css';
import abhiImage from "./vanshika.jpg.jpeg"; 
...
function App() {
  ...
  return (
    <div className="App">
      <header>
        <div className="user">
          <img src={abhiImage} alt="Vanshika" />
          <h3 className="name">Vanshika</h3>
        </div>
      ...
      <section className="home" id="home">
        <h3>HELLO!!</h3>
        <h1>This is <span>Vanshika</span></h1>
      </section>
      ...
      <section className="contact" id="contact">
        ...
        <div className="row">
          <div className="content">
            ...
            <div className="info">
              <h3> <i className="fas fa-envelope"></i> vanshikhajammula@gmail.com</h3>
              <h3> <i className="fas fa-phone"></i> 9494605085 </h3>
